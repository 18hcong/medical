...
const Home = () => {
  ...
  <div class="carousel__left">
      ...
      <h1>Freelance Product <br> Designer Running</h1>
      <p>We develop the relationships that underpin the next phase in your
          organization's growth.</p>
      <ul>
          <li>Master's degree in designing</li>
          <li>Outstanding mobile design</li>
      </ul>
  ...
  <div class="carousel__right">
      <div class="carousel__hinhcha">
          <img src="./images/pic3_1.png" alt="">
          <div class="carousel__hinhcon">
